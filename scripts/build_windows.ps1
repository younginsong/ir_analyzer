...
Compress-Archive -Path (Join-Path $DistDir $AppName) -DestinationPath (Join-Path $ReleaseDir "IR-Analyzer-Windows.zip") -Force

Write-Host ""
Write-Host "Build complete:"
Write-Host "  App folder: $DistDir\\$AppName"
Write-Host "  Zip file:   $ReleaseDir\\IR-Analyzer-Windows.zip"
